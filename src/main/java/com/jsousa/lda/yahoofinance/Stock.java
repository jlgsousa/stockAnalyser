...
import com.jsousa.lda.yahoofinance.histquotes2.*;
...
import com.jsousa.lda.yahoofinance.quotes.stock.StockDividend;
import com.jsousa.lda.yahoofinance.quotes.stock.StockQuote;
import com.jsousa.lda.yahoofinance.quotes.stock.StockStats;
...
public class Stock {
     ...
     * @throws java.io.IOException when there's a connection problem
     * @see         #getHistory(com.jsousa.lda.yahoofinance.histquotes.Interval)
     * @see         #getHistory(java.util.Calendar)
     * @see         #getHistory(java.util.Calendar, java.util.Calendar)
     * @see         #getHistory(java.util.Calendar, com.jsousa.lda.yahoofinance.histquotes.Interval)
     * @see         #getHistory(java.util.Calendar, java.util.Calendar, com.jsousa.lda.yahoofinance.histquotes.Interval)
     */
