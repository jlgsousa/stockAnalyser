package com.jsousa.lda.yahoofinance;

import com.jsousa.lda.yahoofinance.histquotes.HistQuotesRequest;
import com.jsousa.lda.yahoofinance.histquotes.Interval;
import com.jsousa.lda.yahoofinance.quotes.csv.FxQuotesRequest;
import com.jsousa.lda.yahoofinance.quotes.csv.StockQuotesData;
import com.jsousa.lda.yahoofinance.quotes.csv.StockQuotesRequest;
import com.jsousa.lda.yahoofinance.quotes.fx.FxQuote;
import com.jsousa.lda.yahoofinance.quotes.query1v7.FxQuotesQuery1V7Request;
import com.jsousa.lda.yahoofinance.quotes.query1v7.StockQuotesQuery1V7Request;
 ...
 * setting the com.jsousa.lda.yahoofinance.connection.timeout system property.
 * <p>
...
public class YahooFinance {
    ...
    public static final String QUOTES_BASE_URL = System.getProperty("com.jsousa.lda.yahoofinance.baseurl.quotes", "http://download.finance.yahoo.com/d/quotes.csv");
    public static final String QUOTES_QUERY1V7_BASE_URL = System.getProperty("com.jsousa.lda.yahoofinance.baseurl.quotesquery1v7", "https://query1.finance.yahoo.com/v7/finance/quote");
    public static final String QUOTES_QUERY1V7_ENABLED = System.getProperty("com.jsousa.lda.yahoofinance.quotesquery1v7.enabled", "true");
    public static final String HISTQUOTES_BASE_URL = System.getProperty("com.jsousa.lda.yahoofinance.baseurl.histquotes", "https://ichart.yahoo.com/table.csv");
    public static final String HISTQUOTES2_ENABLED = System.getProperty("com.jsousa.lda.yahoofinance.histquotes2.enabled", "true");
    public static final String HISTQUOTES2_BASE_URL = System.getProperty("com.jsousa.lda.yahoofinance.baseurl.histquotes2", "https://query1.finance.yahoo.com/v7/finance/download/");
    public static final String HISTQUOTES_QUERY2V8_BASE_URL = System.getProperty("com.jsousa.lda.yahoofinance.baseurl.histquotesquery2v8", "https://query2.finance.yahoo.com/v8/finance/chart/");
    public static final String HISTQUOTES2_SCRAPE_URL = System.getProperty("com.jsousa.lda.yahoofinance.scrapeurl.histquotes2", "https://finance.yahoo.com/quote/%5EGSPC/options");
    public static final String HISTQUOTES2_CRUMB_URL = System.getProperty("com.jsousa.lda.yahoofinance.crumburl.histquotes2", "https://query1.finance.yahoo.com/v1/test/getcrumb");
    public static final String HISTQUOTES2_CRUMB = System.getProperty("com.jsousa.lda.yahoofinance.crumb", "");
    public static final String HISTQUOTES2_COOKIE = System.getProperty("com.jsousa.lda.yahoofinance.cookie", "");
    public static final String HISTQUOTES2_COOKIE_NAMESPACE = System.getProperty("com.jsousa.lda.yahoofinance.cookie.namespace", "yahoo");
    public static final String HISTQUOTES2_COOKIE_AGREE = System.getProperty("com.jsousa.lda.yahoofinance.cookie.agree", "agree");
    public static final String HISTQUOTES2_COOKIE_OATH_URL = System.getProperty("com.jsousa.lda.yahoofinance.cookie.oathurl", "https://guce.oath.com/consent");
    public static final String HISTQUOTES2_COOKIE_OATH_HOST = System.getProperty("com.jsousa.lda.yahoofinance.cookie.oathhost", "guce.oath.com");
    public static final String HISTQUOTES2_COOKIE_OATH_ORIGIN = System.getProperty("com.jsousa.lda.yahoofinance.cookie.oathorigin", "https://guce.oath.com");
    public static final String HISTQUOTES2_COOKIE_OATH_DONEURL = System.getProperty("com.jsousa.lda.yahoofinance.cookie.oathDoneUrl", "https://guce.yahoo.com/copyConsent?sessionId=");
    public static final String QUOTES_CSV_DELIMITER = ",";
    public static final String TIMEZONE = "America/New_York";
    
    public static final int CONNECTION_TIMEOUT = 
            Integer.parseInt(System.getProperty("com.jsousa.lda.yahoofinance.connection.timeout", "10000"));
    
    /**
    * Sends a basic quotes request to Yahoo Finance. This will return a {@link Stock} object
    * with its {@link com.jsousa.lda.yahoofinance.quotes.stock.StockQuote}, {@link com.jsousa.lda.yahoofinance.quotes.stock.StockStats}
    * and {@link com.jsousa.lda.yahoofinance.quotes.stock.StockDividend} member fields
    ...
    */
     ...
     * object's member field {@link com.jsousa.lda.yahoofinance.histquotes.HistoricalQuote} to be filled in
    ...
    * The Stock objects have their {@link com.jsousa.lda.yahoofinance.quotes.stock.StockQuote}, {@link com.jsousa.lda.yahoofinance.quotes.stock.StockStats}
    * and {@link com.jsousa.lda.yahoofinance.quotes.stock.StockDividend} member fields
    * filled in with the available data.
    * <p>
    ...
    */
     ...
     * Same as the <code>get(String[])</code> method, but with the option to include
     * historical stock quote data. Including historical data will cause the {@link Stock}
     * objects their member field {@link com.jsousa.lda.yahoofinance.histquotes.HistoricalQuote} to be filled in
     * with the default past year term at monthly intervals.
     * <p>
     ...
     * Some common symbols can easily be found in the ENUM {@link com.jsousa.lda.yahoofinance.quotes.fx.FxSymbols}
